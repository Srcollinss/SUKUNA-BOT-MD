...
const spinner2 = { 
  "interval": 150,
  "frames": ["[BEM VINDO A INTERFACE DO SUKUNA BOT]"]}
...
const banner2 = cfonts.render(('[BEM VINDO A INTERFACE DO SUKUNA-MD]'), {
font: 'console',
align: 'center',
gradrient: [`${cor4}`,`${cor2}`], 
...
const banner3 = cfonts.render((`SUKUNA MD 4.0`), {
font: 'simple',             
align: 'center',           
...
authorname = 'SUKUNA-MD-4.0'
packname = '-JR-'
  
function addMetadata(packname, author) {	
if (!packname) packname = '-JR-'; if (!author) author = 'SUKUNA-MD-4.0';	
